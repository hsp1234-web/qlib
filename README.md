...
[![在 Colab 中開啟](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/hsp1234-web/qlib/blob/6.3/Master_Workflow.ipynb)
...
2.  在打開的 Colab 筆記本中，依照儲存格的順序（由 1 至 4），逐一執行即可。
...
1.  在 Colab 筆記本中，執行 **4** 號儲存格，標題為「**(新功能) 啟動互動式回測設定儀表板**」。
