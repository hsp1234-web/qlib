...
class IndicatorsBacktester:
    ...
    def _build_indicator_alias_map(self) -> Dict[str, Tuple[str, int]]:  # pylint: disable=too-complex
        ...
        # MA
        try:
            from . import MovingAverage_Indicator_backtester as module
        ...
        # BOLL
        try:
            from . import BollingerBand_Indicator_backtester as module
        ...
        # HL
        try:
            from . import HL_Indicator_backtester as module
        ...
        # PERC
        try:
            from . import Percentile_Indicator_backtester as module
        ...
        # VALUE
        try:
            from . import VALUE_Indicator_backtester as module
    ...
    def get_indicator_params(  # pylint: disable=unused-argument
        ...
        if alias:
            ...
            module = importlib.import_module(f".{module_name}", package="lo2cin4bt.backtester")
